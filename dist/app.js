(() => {
                  ...
                  function go2(bot, top3) {
                    switch (top3 - bot) {
                      case 0:
                        return pure25([]);
                      case 1:
                        return map43(array1)(f(array[bot]));
                      case 2:
                        return apply6(map43(array2)(f(array[bot])))(f(array[bot + 1]));
                      case 3:
                        return apply6(apply6(map43(array3)(f(array[bot])))(f(array[bot + 1])))(f(array[bot + 2]));
                      default:
                        var pivot = bot + Math.floor((top3 - bot) / 4) * 2;
                        return apply6(map43(concat2)(go2(bot, pivot)))(go2(pivot, top3));
                    }
                  }
      ...
      traversableMaybe = {
        traverse: function(dictApplicative) {
          ...
          return function(v) {
            return function(v1) {
              ...
              ;
              if (v1 instanceof Just) {
                return map43(Just.create)(v(v1.value0));
              }
              ;
        ...
        sequence: function(dictApplicative) {
          ...
          return function(v) {
            ...
            ;
            if (v instanceof Just) {
              return map43(Just.create)(v.value0);
            }
            ;
          ...
          return function(map43) {
            return function(f) {
              var buildFrom = function(x, ys) {
                return apply6(map43(consList)(f(x)))(ys);
              };
              ...
              return function(array) {
                var acc = map43(finalCell)(f(array[array.length - 1]));
      ...
      bitraversableTuple = {
        bitraverse: function(dictApplicative) {
          ...
          return function(f) {
            return function(g) {
              return function(v) {
                return apply6(map43(Tuple.create)(f(v.value0)))(g(v.value1));
              };
            };
          };
        },
        bisequence: function(dictApplicative) {
          ...
          var map43 = map(Apply0.Functor0());
          return function(v) {
            return apply6(map43(Tuple.create)(v.value0))(v.value1);
          };
        },
        Bifunctor0: function() {
  ...
  var unwrap7, prop2, prop22, type_, value, placeholder, class_;
  ...
  var bind12, liftEffect3, pure1, map25, lift8, monadStoreT, monadEffectStoreT, monadStoreStoreT, monadAffStoreT, functorStoreT, bindStoreT, applicativeStoreT, updateStore, runAndEmitStoreT, runStoreT, getStore, emitSelected, monadStoreHalogenM;
  ...
  var $runtime_lazy11, unwrap8, discard2, discard1, bind5, liftEffect4, eq3, pure8, unlessM2, forever2, when2, $$try4, liftAff2, logError2, show4, bind22, $$void6, bindFlipped5, modify_3, mempty4, pure12, identity16, slot_2, Initialize2, Recieve, getMsg, getMsg1, systemInfo, component;
              ...
              return function(url) {
                return function(go2) {
                  return bind32(liftEffect12(create))(function(v) {
                    return bind32(liftEffect12(createWebSocket(unwrap8(url) + "/api/public/server/info", [])))(function(ws) {
                      var $lazy_isOpen = $runtime_lazy11("isOpen", "App.Page.Home", function() {
                        return discard1(delay(1e3))(function() {
                          return bind5(liftEffect4(readyState(ws)))(function(st) {
                          ...
                          return bind5(liftEffect4(readyState(ws)))(function(st) {
                            return when2(eq3(st)(Open.value))(bind5($$try4(liftAff2(fromEffectFnAff(getObject(ws)))))(function(res) {
                              ...
                              if (res instanceof Left) {
                                return liftEffect4(logError2(show4(res.value0)));
                              }
                              ;
  ...
  var input2, domcontentloaded, blur2;
  ...
  var map26, composeKleisli3, composeKleisliFlipped2, readProp2, readString2, mouseHandler, handler$prime, handler2, onClick, onSubmit, focusHandler, onBlur, addForeignPropHandler, onValueInput;
  ...
  var init_Web_Storage = __esm({
    "output/Web.Storage.Storage/index.js"() {
      ...
      init_Effect();
      init_foreign126();
      map28 = /* @__PURE__ */ map(functorEffect);
      getItem = function(s) {
        var $5 = map28(toMaybe);
        var $6 = _getItem(s);
        return function($7) {
  ...
  var unwrap10, map29, alt7, wrap3, Token, LoginUser, LogoutUser, writeToken, tokenKeyJWT, tokenKeyBasic, removeToken, reduce, readToken;
  var init_Store = __esm({
    "output/Store/index.js"() {
      ...
      readToken = function __do3() {
        ...
        return map29(function($25) {
          return Token(Credentials($25));
        })(alt7(map29(function($26) {
          return Left.create(wrap3($26));
        })(basic))(map29(function($27) {
  ...
  var intercalate5, map30, show6, $$Error2, validationError;
  var init_App_Page_Register = __esm({
    "output/App.Page.Register.Error/index.js"() {
      ...
      map30 = /* @__PURE__ */ map(functorNonEmptyArray);
      ...
      validationError = {
        errorToString: function(v) {
          return intercalate5(", ")(map30(show6)(v));
        }
      };
    }
  });
                  ...
                  return function(prop3) {
                    return function(rin) {
                      return function(field) {
                        var v1 = from3(field);
                        return apply3(map31(composeFlipped2)(rin))(map31(insert13(prop3))(v1.result));
                      };
                    };
                  };
                }
                  ...
                  return function(prop3) {
                    return function(rin) {
                      return function(field) {
                        ...
                        return apply3(map31(composeFlipped2)(rin))(map31(insert13(prop3))(hush(result)));
                      };
                    };
                  };
                }
                    ...
                    return function(initialForm) {
                      return function(component6) {
                        ...
                        var runFormAction = function(action2) {
                          return handleAction(new HandleForm(new Eval2(action2)));
                        };
                        var handleAction = function(v) {
  ...
  var bind10, $$void7, map32, innerIsSymbol2, slot3, discard5, map112, modify_6, gets3, unless3, pure14, query4, Initialize4, Receive4, Update, Raise3, subscribe3, connect;
  var init_Halogen_Store3 = __esm({
    "output/Halogen.Store.Connect/index.js"() {
      ...
      map32 = /* @__PURE__ */ map(functorEmitter);
      innerIsSymbol2 = {
        reflectSymbol: function() {
          return "inner";
        }
        ...
        return function(selector) {
          return function(action2) {
            return bind10(emitSelected2(selector))(function(emitter) {
              return $$void7(subscribe2(map32(action2)(emitter)));
            });
          };
        };
      };
  ...
  var bind11, map33, bindFlipped7, join3, apply4, pure15, voidRight2, setHash2, getHash, foldHashes, matchesWith;
  var init_Routing6 = __esm({
    "output/Routing.Hash/index.js"() {
      ...
      map33 = /* @__PURE__ */ map(functorEffect);
      ...
      foldHashes = function(cb) {
        return function(init4) {
          return function __do4() {
            ...
            var win = map33(toEventTarget)(windowImpl)();
            var listener = eventListener(function(v) {
              return bindFlipped7(flip(write)(ref2))(join3(apply4(map33(cb)(read(ref2)))(getHash)));
            })();
  ...
  var slot_3, slot_1, slot_22, slot_32, bind14, get5, discard6, show7, credentialsIsSymbol, emailIsSymbol2, show14, show23, when4, notEq2, pure16, modify_7, map34, selectEq2, Navigate, Initialize5, Receive5, component4;
  var init_App_Component = __esm({
    "output/App.Component.Router/index.js"() {
      ...
      map34 = /* @__PURE__ */ map(functorHalogenM);
      ...
      component4 = function(dictMonadAff) {
        ...
        return function(dictMonadStore) {
          var component22 = component(dictMonadStore)(dictMonadAff);
              ...
              return function(dictNavigate) {
                ...
                var handleAction = function(v) {
                  if (v instanceof Initialize5) {
                    return bind14(map34(function() {
                      var $118 = parse2(routeCodec);
                      return function($119) {
                        return hush($118($119));
                      };
                  ...
                  if (v instanceof Receive5) {
                    return modify_7(function(v1) {
                      ...
                      ;
                      $111.currentUser = v.value0.context;
                      return $111;
                    });
                  }
                  ;
                ...
                return connect1(selectEq2(function(v) {
                  ...
                  "eval": mkEval({
                    handleAction,
                    handleQuery,
                    receive: function($120) {
                      return Just.create(Receive5.create($120));
                    },
  ...
  var apply5, map35, traverse4, toArray3, encode2;
  var init_Data56 = __esm({
    "output/Data.FormURLEncoded/index.js"() {
      ...
      map35 = /* @__PURE__ */ map(functorMaybe);
      ...
      encode2 = /* @__PURE__ */ function() {
        var encodePart = function(v) {
          ...
          if (v.value1 instanceof Just) {
            return apply5(map35(function(key) {
              return function(val) {
                return key + ("=" + val);
              };
  ...
  var pure17, fail3, unsafeReadTagged2, alt8, composeKleisliFlipped3, map36, any3, eq4, bindFlipped8, map113, mapFlipped3, $$try6, pure18, RequestContentError, ResponseBodyError, TimeoutError, RequestFailedError, XHROtherError, request3, defaultRequest, post;
  var init_Affjax5 = __esm({
    "output/Affjax/index.js"() {
      ...
      map36 = /* @__PURE__ */ map(functorMaybe);
        ...
        return function(req) {
          ...
          var extractContent = function(v2) {
            ...
            if (v2 instanceof FormURLEncoded) {
              return note("Body contains values that cannot be encoded as application/x-www-form-urlencoded")(map36(unsafeToForeign)(encode2(v2.value0)));
            }
            ;
          ...
          var headers = function(reqContent) {
            return addHeader(map36(ContentType.create)(bindFlipped8(toMediaType)(reqContent)))(addHeader(map36(Accept.create)(toMediaType2(req.responseFormat)))(req.headers));
          };
          var ajaxRequest = function(v2) {
            return {
              ...
              timeout: fromMaybe(0)(map36(function(v1) {
                return v1;
              })(req.timeout))
            };
          };
  ...
  var map37, nowTime2, nowDateTime2, nowDate2;
  var init_Effect9 = __esm({
    "output/Effect.Now/index.js"() {
      ...
      init_Effect();
      init_foreign132();
      map37 = /* @__PURE__ */ map(functorEffect);
      nowTime2 = /* @__PURE__ */ map37(function($2) {
        return time(toDateTime($2));
      })(now2);
      nowDateTime2 = /* @__PURE__ */ map37(toDateTime)(now2);
      nowDate2 = /* @__PURE__ */ map37(function($3) {
  ...
  var bind16, liftEffect6, bindFlipped9, composeKleisliFlipped4, pure20, bindFlipped1, pure111, map38, discard8, throwError3, selectElement, runHalogenAff, awaitLoad, awaitBody;
  ...
  var traverse_4, bindFlipped10, lookup9, bind17, liftEffect7, discard9, discard12, traverse_12, traverse_22, fork3, parSequence_2, pure21, map39, parallel2, map114, sequential2, map210, insert9, retractFreeAp2, $$delete6, unlessM3, insert12, traverse_32, lookup12, lookup22, foldFree2, alter2, unsubscribe3, queueOrRun, handleLifecycle, handleAff, fresh, evalQ, evalM, evalF;
  var init_Halogen_Aff_Driver2 = __esm({
    "output/Halogen.Aff.Driver.Eval/index.js"() {
      ...
      map39 = /* @__PURE__ */ map(functorCoyoneda);
      ...
      evalQ = function(render2) {
        return function(ref2) {
          return function(q2) {
            return bind17(liftEffect7(read(ref2)))(function(v) {
              return evalM(render2)(ref2)(v["component"]["eval"](new Query(map39(Just.create)(liftCoyoneda(q2)), $$const(Nothing.value))));
            });
          };
        };
      };
  ...
  var bind18, discard10, for_3, traverse_5, fork4, bindFlipped11, traverse_13, traverse_23, traverse_33, discard22, parSequence_3, liftEffect8, pure23, map40, pure112, when5, renderStateX2, $$void9, foreachSlot2, renderStateX_2, tailRecM3, voidLeft4, bind19, liftEffect1, newLifecycleHandlers, handlePending, cleanupSubscriptionsAndForks, runUI;
              ...
              return function(handler3) {
                return function(childrenInRef) {
                  return function(childrenOutRef) {
                    return unComponentSlot(function(slot4) {
                      return function __do4() {
                        var childrenIn = map40(slot4.pop)(read(childrenInRef))();
                        var $$var2 = function() {
                        ...
                        var isDuplicate = map40(function($68) {
  ...
  var map41, parentNode2, nextSibling;
  var init_Web_DOM5 = __esm({
    "output/Web.DOM.Node/index.js"() {
      ...
      init_Web_Internal();
      init_foreign133();
      map41 = /* @__PURE__ */ map(functorEffect);
  ...
  var $runtime_lazy13, $$void10, pure24, traverse_6, unwrap12, when6, not2, identity21, bind110, liftEffect9, map42, bindFlipped12, substInParent, removeChild3, mkSpec, renderSpec, runUI2;
      ...
      runUI2 = function(component6) {
        return function(i2) {
          return function(element3) {
            return bind110(liftEffect9(map42(toDocument)(bindFlipped12(document)(windowImpl))))(function(document2) {
  ...
  var $$for2, bind20, liftEffect10, component5, $$void11, matchesWith2, when7, notEq3, loadUser, main2;
  var init_Main = __esm({
    "output/Main/index.js"() {
      init_App_Component();
      init_App_Data4();
      ...
      init_Store();
      init_Undefined();
      $$for2 = /* @__PURE__ */ $$for(applicativeAff)(traversableMaybe);
