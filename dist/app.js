(() => {
            ...
            return {
              showRecordFields: function(v) {
                return function(record) {
                  ...
                  return " " + (key + (": " + (show15(focus3) + ("," + tail3))));
                };
              }
            };
          };
  ...
  var identity4, Nothing, Just, showMaybe, semigroupMaybe, maybe, isNothing, isJust, functorMaybe, map2, fromMaybe, fromJust, eqMaybe, applyMaybe, bindMaybe, applicativeMaybe;
  ...
  var Left, Right, note, functorEither, map3, either, hush, blush, applyEither, bindEither, applicativeEither;
  ...
  var identity8, traverse, sequenceDefault, traversableArray;
  ...
  var init_Data34 = __esm({
    "output/Data.List/index.js"() {
      ...
      many = function(dictAlternative) {
        ...
        return function(dictLazy) {
          return function(v) {
            return alt8(some(dictAlternative)(dictLazy)(v))(pure26(Nil.value));
          };
        };
      };
    }
                  ...
                  if (rm instanceof Left) {
                    return bind21(v1)(function(rn) {
                      ...
                      if (rn instanceof Left) {
                        return pure26(new Left(append11(rm.value0)(rn.value0)));
                      }
                      ;
  ...
  var init_Data40 = __esm({
    "output/Data.Array/index.js"() {
      ...
      many2 = function(dictAlternative) {
        ...
        return function(dictLazy) {
          return function(v) {
            return alt8(some2(dictAlternative)(dictLazy)(v))(pure113([]));
          };
        };
      };
  ...
  var init_Parsing = __esm({
    "output/Parsing/index.js"() {
            ...
            var go2 = function($copy_step) {
              ...
              function $tco_loop(step4) {
                ...
                if (v1 instanceof Lift3) {
                  $tco_done = true;
                  return map41(Loop.create)(v1.value0);
                }
                ;
      ...
      runParserT = function(dictMonadRec) {
        var map41 = map(dictMonadRec.Monad0().Bind1().Apply0().Functor0());
        var runParserT$prime1 = runParserT$prime(dictMonadRec);
        return function(s) {
          return function(p2) {
            var initialState = new ParseState(s, initialPos, false);
            return map41(fst)(runParserT$prime1(initialState)(p2));
          };
        };
      };
      ...
      oneOfAs = function(dictFunctor) {
        ...
        return function(dictFoldable) {
          ...
          return function(dictMonad) {
            return function(p2) {
              return function(xs) {
                return choice2(map41(function(v) {
  ...
  var showCredentials, eqCredentials;
  ...
  var lmap3, applyFirst3, unwrap5, pure5, WrongEmail, RegError, Email, validate, showValidationError, parse, genericEmail, showEmail, eqEmail;
  var init_App_Data3 = __esm({
    "output/App.Data.Email/index.js"() {
      ...
      parse = function(email) {
        return toEither(andThen(validate(unwrap5(email)))($$const(pure5(email))));
      };
      genericEmail = {
        to: function(x) {
          return x;
  ...
  var gsep2, Home, Login, Register, EmailConfirmation, showRoute, genericRoute, routeCodec, eqRoute;
    ...
    "output/App.Data.Route/index.js"() {
      ...
      showRoute = {
        show: function(v) {
          ...
          ;
          throw new Error("Failed pattern match at App.Data.Route (line 40, column 1 - line 44, column 78): " + [v.constructor.name]);
        }
      };
      genericRoute = {
        to: function(x) {
          ...
          if (x instanceof Inr && (x.value0 instanceof Inr && x.value0.value0 instanceof Inr)) {
            return new EmailConfirmation(x.value0.value0.value0);
          }
          ;
          throw new Error("Failed pattern match at App.Data.Route (line 36, column 1 - line 36, column 48): " + [x.constructor.name]);
        },
        from: function(x) {
  ...
  var require_utils = __commonJS({
    "node_modules/qs/lib/utils.js"(exports, module) {
      ...
      var merge3 = function merge4(target6, source3, options2) {
        ...
        if (isArray2(target6) && isArray2(source3)) {
          source3.forEach(function(item, i2) {
            if (has.call(target6, i2)) {
              var targetItem = target6[i2];
              if (targetItem && typeof targetItem === "object" && item && typeof item === "object") {
                target6[i2] = merge4(targetItem, item, options2);
              } else {
                target6.push(item);
              }
            } else {
  ...
  var mkApiClient, mkUserApi, constructBasicCredentials, apiUserLoginBasicGet, getCredentialsBasicAuth, mkFrontApi, putFrontendLog, constructFrontendLog, getDataFromResponse;
  ...
  var unwrap6, prop2, prop22, type_, value, placeholder, class_;
  ...
  var element2, fieldset, fieldset_, form, h1, input, div3, div_;
  ...
  var $runtime_lazy11, discard2, discard1, bind5, liftEffect3, eq3, pure8, unlessM2, forever2, when2, $$try4, liftAff2, logError2, show4, $$void5, bindFlipped5, modify_3, mempty4, pure1, identity15, slot_2, Initialize2, Recieve, getMsg, getMsg1, handleAction, systemInfo, component;
  var init_App_Page = __esm({
    "output/App.Page.Home/index.js"() {
      ...
      pure1 = /* @__PURE__ */ pure(applicativeMaybe);
      ...
      getMsg = function(dictBind) {
        ...
        return function(dictMonadEffect) {
          return function(dictMonadAff) {
            ...
            var pure26 = pure(MonadEffect0.Monad0().Applicative0());
            return function(dictMonadRec) {
              return function(go2) {
                return bind22(liftEffect12(create))(function(v) {
                  return bind22(liftEffect12(createWebSocket("ws://127.0.1:12000/api/public/server/info", [])))(function(ws) {
                    var $lazy_isOpen = $runtime_lazy11("isOpen", "App.Page.Home", function() {
                      return discard1(delay(1e3))(function() {
                        return bind5(liftEffect3(readyState(ws)))(function(st) {
                          var $62 = eq3(st)(Open.value);
                          if ($62) {
                            return pure8(true);
                          }
                          ;
                          return $lazy_isOpen(73);
                        });
                      });
                    });
                    var isOpen = $lazy_isOpen(69);
                    return discard23(liftAff1(unlessM2(isOpen)(pure8(unit))))(function() {
                      return bind22(liftEffect12($$new(Nothing.value)))(function(v1) {
                        return discard23(void1(liftAff1(forkAff(forever2(discard1(delay(1e3))(function() {
                          return bind5(liftEffect3(readyState(ws)))(function(st) {
                            return when2(eq3(st)(Open.value))(bind5($$try4(liftAff2(fromEffectFnAff(getObject(ws)))))(function(res) {
                              ...
                              if (res instanceof Left) {
                                return liftEffect3(logError2(show4(res.value0)));
                              }
                              ;
                              throw new Error("Failed pattern match at App.Page.Home (line 81, column 6 - line 86, column 50): " + [res.constructor.name]);
                            }));
                          });
                        }))))))(function() {
                          return pure26(v.emitter);
                        });
                      });
                    });
                  });
      ...
      handleAction = function(dictMonadEffect) {
        var getMsg2 = getMsg1(monadEffectHalogenM(dictMonadEffect));
        return function(dictMonadAff) {
          var getMsg3 = getMsg2(monadAffHalogenM(dictMonadAff))(monadRecHalogenM);
          return function(v) {
            if (v instanceof Initialize2) {
              return $$void5(bindFlipped5(subscribe2)(getMsg3(Recieve.create)));
            }
            ;
            ...
            ;
            throw new Error("Failed pattern match at App.Page.Home (line 62, column 1 - line 62, column 64): " + [v.constructor.name]);
          };
        };
      };
      systemInfo = function(dictMonadAff) {
        return mkComponent({
          initialState: $$const({
            msg: mempty4
          }),
          ...
          "eval": mkEval({
            ...
            initialize: pure1(Initialize2.value),
      ...
      component = function(dictMonadAff) {
        return mkComponent({
          ...
          render: $$const(div3([css("center")])([slot_2($$Proxy.value)(0)(systemInfo(dictMonadAff))({
            msg: mempty4
          })])),
  ...
  var init_App_Api2 = __esm({
    "output/App.Api.Utils/index.js"() {
      ...
      init_Effect_Aff2();
      init_Effect4();
      bind6 = /* @__PURE__ */ bind(bindEffect);
          ...
          return function(cred) {
            return function(mkApi) {
              return function(runApi) {
                return bind111(liftEffect11(bind6(mkApiClient(host3, cred))(mkApi)))(function(api) {
                  return liftAff4($$try5(fromEffectFnAff(runApi(api))));
                });
              };
            };
          };
  ...
  var init_Foreign3 = __esm({
    "output/Foreign.Index/index.js"() {
      ...
      unsafeReadProp = function(dictMonad) {
        ...
        return function(k) {
          return function(value17) {
            return unsafeReadPropImpl(fail4(new TypeMismatch("object", typeOf(value17))), pure26, k, value17);
          };
        };
      };
  ...
  var input2, domcontentloaded, blur;
  ...
  var map25, composeKleisli3, composeKleisliFlipped2, readProp2, readString2, mouseHandler, handler$prime, handler2, onClick, onSubmit, focusHandler, onBlur, addForeignPropHandler, onValueInput;
  var init_Halogen_HTML4 = __esm({
    "output/Halogen.HTML.Events/index.js"() {
      ...
      map25 = /* @__PURE__ */ map(functorMaybe);
  ...
  var $$void6, query2, identity16, tell2, request, mkTell;
        ...
        return function(dictIsSymbol) {
          ...
          return function(dictOrd) {
            ...
            return function(slot4) {
              return function(label5) {
                return function(req) {
                  return $$void6(query22(slot4)(label5)(req(unit)));
                };
              };
            };
          };
        ...
        return function(dictIsSymbol) {
          ...
          return function(dictOrd) {
            ...
            return function(slot4) {
              return function(label5) {
                return function(req) {
                  return query22(slot4)(label5)(req(identity16));
                };
              };
            };
          };
  ...
  var bind12, liftEffect4, pure12, map26, lift8, monadStoreT, monadEffectStoreT, monadStoreStoreT, monadAffStoreT, functorStoreT, bindStoreT, applicativeStoreT, updateStore, runAndEmitStoreT, runStoreT, getStore, emitSelected, monadStoreHalogenM;
  ...
  var map27, toParentNode, toDocument, readyState2;
  var init_Web_HTML17 = __esm({
    "output/Web.HTML.HTMLDocument/index.js"() {
      ...
      init_Web_Internal();
      map27 = /* @__PURE__ */ map(functorEffect);
  ...
  var bindFlipped6, LoginUser, LogoutUser, tokenKey, writeToken, removeToken, reduce;
    ...
    "output/Store/index.js"() {
      ...
      writeToken = function(v) {
        return function __do2() {
          ...
          return setItem(tokenKey)(v)(st)();
        };
      };
      removeToken = /* @__PURE__ */ bindFlipped6(/* @__PURE__ */ removeItem(tokenKey))(/* @__PURE__ */ bindFlipped6(localStorage)(windowImpl));
      reduce = function(v) {
        return function(v1) {
          ...
          ;
          throw new Error("Failed pattern match at Store (line 47, column 1 - line 47, column 35): " + [v.constructor.name, v1.constructor.name]);
        };
      };
    }
  });
  ...
  var type_19, value13, bind7, get3, bind13, pure9, discard3, when3, show5, modify_4, Submit, UpdateEmail, UpdatedPassword, initState, component2;
  var init_App_Page2 = __esm({
    "output/App.Page.Login/index.js"() {
      ...
      init_Halogen_Store2();
      init_Store();
      type_19 = /* @__PURE__ */ type_(isPropInputType);
            ...
            return function(dictLogMessages) {
              ...
              return function(dictNow) {
                ...
                var render2 = function(v) {
                  return div_([div3([css("logo")])([]), div3([css("login-block")])([h1([])([text("login")]), form([])([fieldset_([input([placeholder("Email"), type_19(InputEmail.value), onValueInput(UpdateEmail.create)]), input([placeholder("Password"), type_19(InputPassword.value), onValueInput(UpdatedPassword.create)]), input([type_19(InputSubmit.value), value13("Sign in"), onClick(function(v1) {
                    return Submit.value;
                  })])])])])]);
                };
                var handleAction2 = function(v) {
                        ...
                        if (mkTpl instanceof Just) {
                          return bind7(liftEffect11(constructBasicCredentials(mkTpl.value0.fst, mkTpl.value0.snd)))(function(cred) {
                            return bind7(makeRequest3(v1.config.url)(Nothing.value)(mkUserApi)(runFn2(apiUserLoginBasicGet)(cred)))(function(res) {
                              ...
                              ;
                              if (res instanceof Left) {
                                return logDebug1(show5(res.value0));
                              }
                              ;
                              throw new Error("Failed pattern match at App.Page.Login (line 72, column 12 - line 77, column 41): " + [res.constructor.name]);
                            });
                          });
                        }
                        ;
                  ...
                  ;
                  throw new Error("Failed pattern match at App.Page.Login (line 61, column 3 - line 80, column 39): " + [v.constructor.name]);
                };
                return mkComponent({
  ...
  var intercalate5, map28, show6, $$Error2, validationError;
  var init_App_Page_Register = __esm({
    "output/App.Page.Register.Error/index.js"() {
      ...
      map28 = /* @__PURE__ */ map(functorNonEmptyArray);
      show6 = /* @__PURE__ */ show(showValidationError);
      $$Error2 = function(x) {
        return x;
      };
      validationError = {
        errorToString: function(v) {
          return intercalate5(", ")(map28(show6)(v));
        }
      };
    }
  });
  ...
  var textInput2, type_20, value15, Receive2, Eval, render;
  var init_App_Page_Register2 = __esm({
    "output/App.Page.Register.Html/index.js"() {
      ...
      render = function(v) {
        ...
        })([placeholder("Email"), type_20(InputEmail.value)]), textInput2({
          state: v.fields.password,
          action: v.actions.password
        })([placeholder("Password "), type_20(InputPassword.value)]), input([type_20(InputSubmit.value), value15("Sign up")])])]);
      };
    }
  });
  ...
  var init_Formless = __esm({
    "output/Formless/index.js"() {
      ...
      init_Unsafe2();
      init_Web_Event3();
      map29 = /* @__PURE__ */ map(functorMaybe);
      ...
      bindFlipped7 = /* @__PURE__ */ bindFlipped(bindHalogenM);
      innerIsSymbol = {
        reflectSymbol: function() {
          return "inner";
        }
                  ...
                  return function(prop3) {
                    return function(rin) {
                      return function(field) {
                        var v1 = from3(field);
                        return apply3(map29(composeFlipped2)(rin))(map29(insert13(prop3))(v1.result));
                      };
                    };
                  };
                }
                  ...
                  return function(prop3) {
                    return function(rin) {
                      return function(field) {
                        ...
                        return apply3(map29(composeFlipped2)(rin))(map29(insert13(prop3))(hush(result)));
                      };
                    };
                  };
                }
                    ...
                    return function(initialForm) {
                      return function(component6) {
                        ...
                        var runValidation = function(fieldKey) {
                          return bind9(bindFlipped7(function() {
                        ...
                        return mkComponent({
                          ...
                          render: function(state3) {
                            ...
                            return slot2($$Proxy.value)(unit)(component6)(context)(HandleForm.create);
                          },
                          "eval": mkEval({
  ...
  var lmap5, pure11, put3, emailIsSymbol, mapRecordWithIndexCons2, constMapping2, passwordIsSymbol, mapRecordWithIndexCons1, mkFieldStates12, mkFieldActions12, hfoldlRecordWithIndex2, foldlRecordCons2, foldlRecordCons1, mkFieldResults12, mkFieldOutputs12, mkConfig12, mempty5, identity19, validate3, component3;
  var init_App_Page_Register3 = __esm({
    "output/App.Page.Register.Component/index.js"() {
      ...
      component3 = function(dictMonadAff) {
        var validation3 = {
          email: function() {
  ...
  var bind10, $$void7, map30, innerIsSymbol2, slot3, discard5, map112, modify_6, gets3, unless3, pure14, query4, Initialize4, Receive4, Update, Raise3, subscribe3, connect;
  var init_Halogen_Store3 = __esm({
    "output/Halogen.Store.Connect/index.js"() {
      ...
      map30 = /* @__PURE__ */ map(functorEmitter);
      innerIsSymbol2 = {
        reflectSymbol: function() {
          return "inner";
        }
        ...
        return function(selector) {
          return function(action2) {
            return bind10(emitSelected2(selector))(function(emitter) {
              return $$void7(subscribe2(map30(action2)(emitter)));
            });
          };
        };
      };
            ...
            return function(component6) {
              var renderInner = function(input3) {
                return function(context) {
                  return slot3($$Proxy.value)(unit)(component6)({
                    input: input3,
                    context
                  })(Raise3.create);
                };
  ...
  var bind11, map31, bindFlipped8, join3, apply4, pure15, voidRight2, setHash2, getHash, foldHashes, matchesWith;
  var init_Routing6 = __esm({
    "output/Routing.Hash/index.js"() {
      ...
      map31 = /* @__PURE__ */ map(functorEffect);
      bindFlipped8 = /* @__PURE__ */ bindFlipped(bindEffect);
      ...
      foldHashes = function(cb) {
        return function(init4) {
          return function __do2() {
            ...
            var win = map31(toEventTarget)(windowImpl)();
            var listener = eventListener(function(v) {
              return bindFlipped8(flip(write)(ref2))(join3(apply4(map31(cb)(read(ref2)))(getHash)));
            })();
  ...
  var slot_3, slot_1, slot_22, slot_32, bind14, get5, discard6, show7, credentialsIsSymbol, emailIsSymbol2, show14, show23, when4, notEq2, pure16, modify_7, map32, selectEq2, Navigate, Initialize5, Receive5, component4;
  var init_App_Component = __esm({
    "output/App.Component.Router/index.js"() {
      ...
      show7 = /* @__PURE__ */ show(/* @__PURE__ */ showMaybe(showRoute));
      credentialsIsSymbol = {
        reflectSymbol: function() {
          return "credentials";
        }
      ...
      show14 = /* @__PURE__ */ show(/* @__PURE__ */ showMaybe(/* @__PURE__ */ showRecord()()(/* @__PURE__ */ showRecordFieldsCons(credentialsIsSymbol)(/* @__PURE__ */ showRecordFieldsConsNil(emailIsSymbol2)(showEmail))(showCredentials))));
      ...
      map32 = /* @__PURE__ */ map(functorHalogenM);
      ...
      component4 = function(dictMonadAff) {
        ...
        return function(dictMonadStore) {
          var component32 = component2(dictMonadStore)(dictMonadAff);
          ...
          return function(dictNow) {
            ...
            return function(dictLogMessages) {
              ...
              return function(dictNavigate) {
                var component42 = component32(dictNavigate)(dictLogMessages)(dictNow);
                var navigate2 = navigate(navigateHalogenM(dictNavigate));
                var render2 = function(v) {
                  if (v.route instanceof Just) {
                    ...
                    if (v.route.value0 instanceof Login) {
                      return slot_22($$Proxy.value)(unit)(component42)({
                        redirect: true
                      });
                    }
                    ;
                    if (v.route.value0 instanceof Register) {
                      return slot_32($$Proxy.value)(unit)(component22)(unit);
                    }
                    ;
                    ...
                    ;
                    throw new Error("Failed pattern match at App.Component.Router (line 117, column 5 - line 121, column 39): " + [v.route.value0.constructor.name]);
                  }
                  ;
                ...
                var handleQuery = function(v) {
                  return bind14(get5)(function(v1) {
                    return discard6(log4(Debug.value)("App.Component.Router,line 88: route:" + (show7(v1.route) + (", user:" + (show14(v1.currentUser) + (", destination:" + show23(v.value0)))))))(function() {
                ...
                var handleAction2 = function(v) {
                  if (v instanceof Initialize5) {
                    return bind14(map32(function() {
                      var $117 = parse2(routeCodec);
                      return function($118) {
                        return hush($117($118));
                      };
                  ...
                  if (v instanceof Receive5) {
                    return modify_7(function(v1) {
                      ...
                      ;
                      $110.currentUser = v.value0.context;
                      return $110;
                    });
                  }
                  ;
                  throw new Error("Failed pattern match at App.Component.Router (line 80, column 3 - line 80, column 75): " + [v.constructor.name]);
                };
                return connect1(selectEq2(function(v) {
                  ...
                  "eval": mkEval({
                    ...
                    receive: function($119) {
                      return Just.create(Receive5.create($119));
                    },
  ...
  var unwrap8, Accept, ContentType, RequestHeader, value16, name15;
  ...
  var apply5, map33, traverse4, toArray3, encode2;
      ...
      encode2 = /* @__PURE__ */ function() {
        var encodePart = function(v) {
          ...
          if (v.value1 instanceof Just) {
            return apply5(map33(function(key) {
              return function(val) {
                return key + ("=" + val);
              };
  ...
  var pure17, fail3, unsafeReadTagged2, alt7, composeKleisliFlipped3, map34, any3, eq4, bindFlipped9, map113, mapFlipped3, $$try6, pure18, RequestContentError, ResponseBodyError, TimeoutError, RequestFailedError, XHROtherError, request3, defaultRequest, post;
        ...
        return function(req) {
          ...
          var extractContent = function(v2) {
            ...
            if (v2 instanceof FormURLEncoded) {
              return note("Body contains values that cannot be encoded as application/x-www-form-urlencoded")(map34(unsafeToForeign)(encode2(v2.value0)));
            }
            ;
          ...
          var headers = function(reqContent) {
            return addHeader(map34(ContentType.create)(bindFlipped9(toMediaType)(reqContent)))(addHeader(map34(Accept.create)(toMediaType2(req.responseFormat)))(req.headers));
          };
          var ajaxRequest = function(v2) {
            return {
              ...
              timeout: fromMaybe(0)(map34(function(v1) {
                return v1;
              })(req.timeout))
            };
          };
  ...
  var map35, nowTime2, nowDateTime2, nowDate2;
  var init_Effect9 = __esm({
    "output/Effect.Now/index.js"() {
      ...
      nowTime2 = /* @__PURE__ */ map35(function($2) {
        return time(toDateTime($2));
      })(now2);
      nowDateTime2 = /* @__PURE__ */ map35(toDateTime)(now2);
      nowDate2 = /* @__PURE__ */ map35(function($3) {
  ...
  var bind16, liftEffect6, bindFlipped10, composeKleisliFlipped4, pure20, bindFlipped1, pure111, map36, discard8, throwError3, selectElement, runHalogenAff, awaitLoad, awaitBody;
  var init_Halogen_Aff = __esm({
    "output/Halogen.Aff.Util/index.js"() {
      ...
      bindFlipped10 = /* @__PURE__ */ bindFlipped(bindEffect);
      ...
      awaitLoad = /* @__PURE__ */ makeAff(function(callback) {
        return function __do2() {
          var rs = bindFlipped10(readyState2)(bindFlipped10(document)(windowImpl))();
  ...
  var init_Halogen_Aff_Driver = __esm({
    "output/Halogen.Aff.Driver.State/index.js"() {
      ...
      initDriverState = function(component6) {
        return function(input3) {
  ...
  var traverse_4, bindFlipped11, lookup9, bind17, liftEffect7, discard9, discard12, traverse_12, traverse_22, fork3, parSequence_2, pure21, map37, parallel2, map114, sequential2, map210, insert9, retractFreeAp2, $$delete6, unlessM3, insert12, traverse_32, lookup12, lookup22, foldFree2, alter2, unsubscribe3, queueOrRun, handleLifecycle, handleAff, fresh, evalQ, evalM, evalF;
  var init_Halogen_Aff_Driver2 = __esm({
    "output/Halogen.Aff.Driver.Eval/index.js"() {
      ...
      bindFlipped11 = /* @__PURE__ */ bindFlipped(bindMaybe);
      ...
      map37 = /* @__PURE__ */ map(functorCoyoneda);
      ...
      unsubscribe3 = function(sid) {
        return function(ref2) {
          return function __do2() {
            ...
            return traverse_4(unsubscribe)(bindFlipped11(lookup9(sid))(subs))();
          };
        };
      };
      ...
      evalQ = function(render2) {
        return function(ref2) {
          return function(q2) {
            return bind17(liftEffect7(read(ref2)))(function(v) {
              return evalM(render2)(ref2)(v["component"]["eval"](new Query(map37(Just.create)(liftCoyoneda(q2)), $$const(Nothing.value))));
            });
          };
        };
      };
                  ...
                  return bind17(fresh(ForkId)(ref2))(function(fid) {
                    return bind17(liftEffect7(read(ref2)))(function(v2) {
                      return bind17(liftEffect7($$new(false)))(function(doneRef) {
                        return bind17(fork3($$finally(liftEffect7(function __do2() {
  ...
  var bind18, discard10, for_3, traverse_5, fork4, bindFlipped12, traverse_13, traverse_23, traverse_33, discard22, parSequence_3, liftEffect8, pure23, map38, pure112, when5, renderStateX2, $$void9, foreachSlot2, renderStateX_2, tailRecM3, voidLeft4, bind19, liftEffect1, newLifecycleHandlers, handlePending, cleanupSubscriptionsAndForks, runUI;
  var init_Halogen_Aff2 = __esm({
    "output/Halogen.Aff.Driver/index.js"() {
      ...
      map38 = /* @__PURE__ */ map(functorEffect);
      ...
      cleanupSubscriptionsAndForks = function(v) {
        return function __do2() {
          ...
          bindFlipped12(traverse_33(function() {
          ...
          return function(i2) {
                ...
                return function(j) {
                  return unComponent(function(c) {
                    return function __do2() {
                      ...
                      bindFlipped12(unDriverStateX(function() {
                        var $62 = render2(lchs);
                        return function($63) {
                      ...
                      bindFlipped12(squashChildInitializers(lchs)(pre2.initializers))(read($$var2))();
                      return $$var2;
                    };
                  });
                };
            ...
            return bind19(liftEffect8(newLifecycleHandlers))(function(lchs) {
              return bind19(liftEffect8($$new(false)))(function(disposed) {
                return handleLifecycle(lchs)(function __do2() {
                  var sio = create();
                  var dsx = bindFlipped12(read)(runComponent(lchs)(function() {
  ...
  var map39, parentNode2, nextSibling;
  ...
  var $runtime_lazy13, $$void10, pure24, traverse_6, unwrap9, when6, not2, identity21, bind110, liftEffect9, map40, bindFlipped13, substInParent, removeChild3, mkSpec, renderSpec, runUI2;
  var init_Halogen_VDom6 = __esm({
    "output/Halogen.VDom.Driver/index.js"() {
      ...
      bindFlipped13 = /* @__PURE__ */ bindFlipped(bindEffect);
      ...
      runUI2 = function(component6) {
        return function(i2) {
          return function(element3) {
            return bind110(liftEffect9(map40(toDocument)(bindFlipped13(document)(windowImpl))))(function(document2) {
  ...
  var bind20, pure25, component5, $$void11, liftEffect10, matchesWith2, when7, notEq3, main2;
  var init_Main = __esm({
    "output/Main/index.js"() {
      init_App_Component();
      init_App_Data4();
      ...
      pure25 = /* @__PURE__ */ pure(applicativeAff);
      component5 = /* @__PURE__ */ component4(monadAffAppM)(monadStoreAppM)(nowAppM)(logMessagesAppM)(navigateAppM);
      ...
      main2 = function(config) {
        return runHalogenAff(bind20(awaitBody)(function(body2) {
          return bind20(pure25(Nothing.value))(function(v) {
            var initialStore = {
              config,
              currentUser: v
            };
